...
nbaMap = "./images/nba-map.gif"
nbaLogo = "./images/nbaLogo.gif"
nbaFinal = "./images/nbaFinal.gif"
NBAwinner = "./images/winneNBA.gif"
...
def confFinals():
    ...
    msg = (
        ...
        + str(AeastConfFinals[0])
        + str(" VS ")
        + str(BeastConfFinals[0])
        + str("\n\nWestern conference\n\n")
        + str(AwestConfFinals[0])
        + str(" VS ")
        + str(BwestConfFinals[0])
    )
    choices = ["NBA Final"]
...
def confHalfFinal():
    ...
    msg = (
        "Conferences half-final :\n\n"
        + str("Eastern conference\n\n")
        + str(AeastFirstTour[0])
        + str(" VS ")
        + str(BeastFirstTour[0])
        + str("\n")
        + str(CeastFirstTour[0])
        + str(" VS ")
        + str(DeastFirstTour[0])
        + str("\n\nWestern conference\n\n")
        + str(AwestFirstTour[0])
        + str(" VS ")
        + str(BwestFirstTour[0])
        + str("\n")
        + str(CwestFirstTour[0])
        + str(" VS ")
        + str(DwestFirstTour[0])
    )
...
def play():
    ...
    msg = (
        "Best 8 Teams Eastern conference :\n\n"
        + str(bestBeginEast[0])
        + str(" , ")
        + str(bestBeginEast[1])
        + str(" , ")
...
def begin():
    msg = (
        "Welcome to the NBA championship\n\nEastern Conference\n\n"
        + str(eastConf[0])
        + str(" , ")
        + str(eastConf[1])
        + str(" , ")
